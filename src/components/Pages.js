...
const Pages = ({ pages, setCurrentPage, currentEmployees, sortedEmployees }) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentEmployees.length}</b> out of <b>{sortedEmployees.length}</b> employes.</div>
